...
function  analysis_10_second_laser_modulation(stim_info, stim_time, spike_time, unit_id, output_name )
...
Laser.unit_id = unit_id;

Laser.total_spikes = total_spikes;
Laser.p = [];
Laser.p_window = resp_window;

Laser.pre_stim_time = pre_stim_time;
Laser.post_stim_time = post_stim_time;
Laser.psth_all = psth_all;
Laser.bin_x = bin_x;
Laser.stim_spike_time_rep = stim_spike_time_rep;
Laser.blank_duration = blank_duration;
Laser.stim1_duration = stim1_duration;
Laser.firing_rate_stim = firing_rate_stim;



save(output_name, 'Laser')


%% figure parameters

[~, figure_name_str] = fileparts(stim_info);
figure_name_str='10_second_laser_strong';
...
if 1
     ...
     stim_organization = reshape(1:ntemplate, 1, 1); %128 position
...
%     end
%     
    figure_raster_psth( Laser, stim_organization, figure_name_str )
