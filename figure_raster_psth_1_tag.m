function [  ] = figure_raster_psth_1_tag( data_info, i_unit, stim_organization )
%FIGURE_raster psth
%
...
figure('position', [ 171          23        1223         954]);%667   202   983   516
...
for j = 1:row
    for k = 1:col
       ...
       for mm=1:10
        rectangle('Position',[0+(mm-1)*0.05 0.2 0.01 30], 'FaceColor',[0.61 0.84 0.95  ], 'EdgeColor', [0.61 0.84 0.95   ]);   %0.9 0.94 1   %0.61 0.84 0.95
       end
        ...
        % psth
         ...
         % rectangle('Position',[0 0.2 stim1_duration 200], 'FaceColor',[0.61 0.95 0.84 ], 'EdgeColor', [0.61 0.95 0.84 ]);   %0.9 0.94 1   %0.61 0.84 0.95
          alpha(.1)
          hold on
